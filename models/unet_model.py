...
class UNetModelBase:
    ...
    def conv_block(inputs, num_filters: int, kernel: tuple = (3, 3), strides: tuple = (1, 1), padding: str = "same",
               ...
               l_batch_normalization: bool = True, weight_decay=0.0):
        """
    ...
    def encoder_block_deepru(self, inputs, channels, strides, kernel: tuple = (3, 3), nconv_res: int = 3, padding: str = "same",
                             activation="LeakyReLU",  kernel_init="he_normal", l_batch_normalization: bool = True, dropout=0.1, weight_decay=0.0001):
    ...
    def decoder_block_deepru(self, inputs, skip_features, channels, size, interpolation: str = "bilinear", nconv_res: int = 3,
                             ...
                             l_batch_normalization: bool = True, dropout=0.1, weight_decay=0.0001):
    ...
    def residual_block(self, inputs, channels, kernel: tuple = (3,3), nconv_res: int = 3, padding: str = "same",
                       activation="LeakyReLU", kernel_init="he_normal", l_batch_normalization: bool = True, weight_decay=0.0):
...
class DeepRU_UNet(Sha_UNet):
    ...
    def set_model(self):
        ...
        encoder_decoder_args = {key: hparams_deepru[key] for key in ["kernel", "padding", "nconv_res", "activation", "dropout", "weight_decay",
