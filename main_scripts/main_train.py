...
def run(train_dir: str = "/p/scratch/deepacf/deeprain/bing/downscaling_maelstrom/train",
    ...
    train_loader = create_loader(train_dir, vars_in=vars_in, vars_out=vars_out, patch_size=16, stat_path=train_dir,#'/p/home/jusers/bragilovski1/juwels/data/precip_dataset',
    ...
    val_loader = create_loader(file_path=val_dir,
                               ...
                               vars_out=vars_out,
                               mode="test",
                               stat_path=train_dir,#'/p/home/jusers/bragilovski1/juwels/data/precip_dataset',
                               patch_size=16,
