...
from downscaling_ap5.handle_data.handle_data_class import HandleDataClass, get_dataset_filename
from downscaling_ap5.handle_data.all_normalizations import ZScore
from statistical_evaluation import Scores
from downscaling_ap5.postprocess.postprocess import get_model_info, run_evaluation_time, run_evaluation_spatial
from downscaling_ap5.postprocess.test_dataset_pytorch import test_dataset
from downscaling_ap5.models_pytorch.unet_model import UNet as unet
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_directory", "-data_dir", dest="data_dir", type=str, required=False,
                        default="C:\\Users\\max_b\\PycharmProjects\\downscaling_maelstrom\\downscaling_ap5\\model_base_dir\\wgan\\downscaling_tier2_train.nc",
    ...
    parser.add_argument("--model_base_directory", "-model_base_dir", dest="model_base_dir", type=str, required=False,
                        default="C:\\Users\\max_b\\PycharmProjects\\downscaling_maelstrom\\downscaling_ap5\\model_base_dir\\",
