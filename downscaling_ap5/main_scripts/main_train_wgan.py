...
def main(parser_args):
    ...
    t0_save = timer()
    ds_train, ds_val = xr.open_dataset(os.path.join(datadir, "preproc_era5_crea6_train.nc"),chunks="auto"),  xr.open_dataset(os.path.join(datadir, "preproc_era5_crea6_val.nc")) 
    # chunks="auto"), xr.open_dataset(os.path.join(datadir, "preproc_era5_crea6_val.nc"))
